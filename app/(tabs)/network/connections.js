...
// console.log("userId hu mai connection se User",userId)
...
const fetchConnections = async ()=>{
  try {
    const response = await axios.get(`http://192.168.165.136:8001/connections/${userId}`)
    setConnections(response.data.connections)

  } catch (error) {
    console.log("Error in fetching connection in connection.js",error)
  }
}
// console.log("connection.js se connection" ,connections )
return (
